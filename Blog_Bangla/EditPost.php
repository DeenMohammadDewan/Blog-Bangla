        ...
        <form class="" action="EditPost.php?id=<?php echo $SarchQueryParameter; ?>" method="post" enctype="multipart/form-data">
            <div class="card bg-secondary text-light mb-3">
                  ...
                  <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="PostTitle" id="title" placeholder="Type tittle here" value="<?php echo $TitleToBeUpdated; ?>">
                     </div>
                    ...
                    <div class="form-group">
                     ...
                     <spna class="FieldInfo">Existing Image: </spna>
                     ...
                     <textarea class="form-control" id="Post" name="PostDescription" cols="80" rows="8">
